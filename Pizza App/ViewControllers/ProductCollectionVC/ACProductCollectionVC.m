...
@interface ACProductCollectionVC () <CAAnimationDelegate>
{
    UILabel *numberBadge;
    BOOL isSearching;
...
@implementation ACProductCollectionVC
...
- (void)viewDidLoad {
    ...
    [manager allProductsListSubCategory:[[NSUserDefaults standardUserDefaults] categoryID]  subCategoryIDObject:_subCategoryID completionBlock:^(NSString *message, NSMutableArray * resArr,BOOL isSuccessfull) {
...
//        [tempDict setValue:[dict valueForKey:@"category_id"] forKey:@"category_id"];
//        [tempDict setValue:[dict valueForKey:@"description"] forKey:@"description"];
//        [tempDict setValue:[dict valueForKey:@"id"] forKey:@"id"];
//        [tempDict setValue:[dict valueForKey:@"image1"] forKey:@"image1"];
//        [tempDict setValue:[dict valueForKey:@"name"] forKey:@"name"];
//        [tempDict setValue:[dict valueForKey:@"price"] forKey:@"price"];
//        [tempDict setValue:[dict valueForKey:@"promotion"] forKey:@"promotion"];
//        [tempDict setValue:[dict valueForKey:@"subcategory_id"] forKey:@"subcategory_id"];
//        [tempDict setValue:[dict valueForKey:@"variation"] forKey:@"variation"];
...
//                         Product *productModel = self.productObjects[indexPath.row];
//                         
